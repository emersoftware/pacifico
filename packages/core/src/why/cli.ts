...
${C.bold}Usage:${C.reset}
  ...
  pacifico why <path>:<line>       The commit that last changed one line (git blame)
  pacifico why <commit-ish>        One commit and the sessions that produced it
  pacifico why "<free text>"       Sessions in this repo matching a topic (no git)
