...
Usage:
  pacifico wrapped                  This year, opened in your browser
  pacifico wrapped --year 2025      A past calendar year
  pacifico wrapped --out w.html     Write the page to a file instead of opening
  pacifico wrapped --stdout         Print the underlying JSON (no HTML)
