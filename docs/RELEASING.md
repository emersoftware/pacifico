...
3. Commit and push a matching `vX.Y.Z` tag. The [Release workflow](../.github/workflows/release.yml) builds and tests native binaries on macOS and Linux for ARM64 and x86-64.
