...
- Brand headers use the light-mode waves, lowercase Instrument Serif wordmark, and the localized landing tagline. Favicons use the waves alone for legibility.
- Write comments and documentation in English, without em dashes.
- Use the configured owner identity for commits; do not add agent coauthor trailers.
- Release under emersoftware using docs/RELEASING.md.
